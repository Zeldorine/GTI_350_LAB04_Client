...
//
// Auteur : T. Cazorla 
import gti610_lab04_client_tcp.GTI610_LAB04_Client_TCP;
import java.io.*;
import java.net.*;
import java.util.*;
...
public class CommunicationSocket extends Observable {
    ...
    public CommunicationSocket(String host, int port, String nomSymbolique, Observer observateur) {
        ...
        ConnectionSocket connectionSocket = new CommunicationSocket.ConnectionSocket(host, port);
    ...
    /**
     * Modélisation de la socket de connexion du client
     *
     * @author Tony CAZORLA
     * @version 1.0.0
     */
    private class ConnectionSocket extends Thread {
        ...
        /*
         * Port du serveur à contacter
         */
        private final int portServeur;

        /**
         * Créer une socket de connexion avec un host et port donnés.
         *
         ...
         * @version 1.0.0
         */
        private ConnectionSocket(String host, int port) {
            super();
        ...
        private boolean connecter() {
            ...
            while (true) {
                ...
                try {
                    ...
                    isConnecte.set(true);
                    adresse = socketClient.getLocalAddress().getHostAddress();
                    ...
                    e.printStackTrace();
                    System.out.println("Echec : problème d'entree/sortie !");
                    setChanged();
                    notifyObservers(GTI610_LAB04_Client_TCP.ERROR_CODE_SERVER);
                    fermerForce();
            ...
            return initFlux(socketClient);
        }

        /**
         * Etablir la connexion avec un serveur cible.
         *
         * @return void
         *
         * @since 1.0.0
